...
import 'package:flutter_deer/user/page/input_text_page.dart';
import 'package:flutter_deer/user/widgets/pay_type_dialog.dart';
import 'package:flutter_deer/user/user_router.dart';
import 'package:flutter_deer/user/widgets/price_input_dialog.dart';
import 'package:flutter_deer/user/widgets/send_type_dialog.dart';
...
class _UserSettingPageState extends State<UserSettingPage> {
  ...
  String _phone = '';
  String _userIntroduction = '零食铺子坚果饮料美酒佳肴…';
        ...
        children: <Widget>[
            ...
            onTap: () {
              AppNavigator.pushResult(context,
                  InputTextPage(
                    ...
                    setState(() {
                      _userIntroduction =result.toString();
                    });
                  });
            },
          ),
          ...
          Visibility(
            ...
            child: ClickItem(
              ...
              onTap: () => NavigatorUtils.push(context, UserRouter.freightConfigPage),
            ),
          ),
          Gaps.vGap32,
          const Padding(
          ...
          ClickItem(
            ...
            content: _address,
            onTap: () {
              NavigatorUtils.pushResult(context, UserRouter.addressSelectPage, (result) {
                setState(() {
